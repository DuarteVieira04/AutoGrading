<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="post" action="{{ route('grading-processes.store') }}" class="space-y-6 bg-white p-6 shadow sm:rounded-lg border border-gray-200">
                @csrf
                @include('grading-processes._form', ['process' => null])
